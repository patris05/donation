...
<body>
    <div class="fixed-top">
        ...
        <div class="container">
        <!-- Example section where you want to display username separately -->
        <div class="username-section">
            <p>Welcome, <?php echo $_SESSION['userName']; ?></p>
            <!-- Tambahkan elemen HTML atau konten lain yang ingin Anda tambahkan di sini -->
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6 align-item-center">
                        <div class="home-info">
                            ...
                            <div class="buttons">
                                <a href="form_input.php" class="btn1">Buat Donasi</a>
                            </div> 
    ...
    <section class="don-sec" id="donation">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="don-box">
                        <img src="asset/lansia jualan (sosial).jpg" alt="img">
                        <h3>Sosial</h3>
                        <p>Peduli lansia renta jualan peyek hingga puluhan kilometer.</p>
                        <a href="#contact" class="btn1">Donasi sekarang</a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="don-box">
                        <img src="asset/menderita hidrosefalus (kesehatan).webp" alt="img">
                        <h3>Kesehatan</h3>
                        <p>Sedekah datangkan kesembuhan anak hidrosefalus.</p>
                        <a href="#contact" class="btn1">Donasi sekarang</a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="don-box">
                        <img src="asset/anak yatim (sosial).jpg" alt="img">
                        <h3>Sosial</h3>
                        <p>Konsumsi untuk anak yatim hal yg membuat bahagi  .</p>
                        <a href="#contact" class="btn1">Donasi sekarang</a>
                    </div>
                </div>
            </div>
